	...
	function setScrollableContent(i){
		...
		scrollableContent = "<tr class=\"product-details-row-scrollable\" row-index=\"\"> <td class=\"product-detail-cell\" id=\"debitNoteSerial\"> <input type=\"text\" class=\"table-cell-input text-center\" id=\"debitNoteSerial\" name=\"debitNoteProducts["+i+"][debitNoteSerial]\" value=\"\" readonly> </td> <td class=\"product-detail-cell\" id=\"description\"> <input type=\"text\" class=\"table-cell-input\" id=\"description\" name=\"debitNoteProducts["+i+"][description]\" value=\"\"><a href=\"javascript:;\" id=\"search_product\"><i class=\"fa fa-search\"></i></a> </td> <td class=\"product-detail-cell\" id=\"hsn\"> <input type=\"text\" class=\"table-cell-input\" id=\"hsn\" name=\"debitNoteProducts["+i+"][hsn]\" value=\"\"> </td> <td class=\"product-detail-cell\" id=\"quantity\"> <input type=\"text\" class=\"table-cell-input\" id=\"quantity\" name=\"debitNoteProducts["+i+"][quantity]\" value=\"1\"> </td> <td class=\"product-detail-cell\" id=\"unit\"> <select id=\"unit\" name=\"debitNoteProducts["+i+"][unit]\" class=\"table-cell-input\"> <option value=\"NOS\">NOS</option><option value=\"BGS\">Bags</option><option value=\"Brass\">Brass</option><option value=\"BTL\">Bottles</option><option value=\"CAN\">Cans</option><option value=\"KG\">Kilograms</option><option value=\"LTR\">liter</option><option value=\"MTR\">Meter</option><option value=\"CH\">Chhota Hatti</option></select> </td> <td class=\"product-detail-cell\" id=\"saleValue\"> <input type=\"text\" class=\"table-cell-input\" id=\"saleValue\" name=\"debitNoteProducts["+i+"][saleValue]\" value=\"\"> </td> <td class=\"product-detail-cell\" id=\"discountRate\" value=\"0.00\"> <input type=\"text\" class=\"table-cell-input\" id=\"discountRate\" name=\"debitNoteProducts["+i+"][discountRate]\" value=\"0.00\"> </td> <td class=\"product-detail-cell d-none\" id=\"discountValue\"> <input type=\"text\" class=\"table-cell-input\" id=\"discountValue\" name=\"debitNoteProducts["+i+"][discountValue]\" value=\"0.00\"> </td> <td class=\"product-detail-cell readonly-cell\" id=\"taxableValue\"> <input type=\"text\" class=\"table-cell-input\" id=\"taxableValue\" name=\"debitNoteProducts["+i+"][taxableValue]\" value=\"0.00\" readonly> </td> <td class=\"product-detail-cell\" id=\"taxRate\"> <select name=\"debitNoteProducts["+i+"][taxRate]\" id=\"taxRate\" class=\"table-cell-input\" > <option value=\"0.00\">0 %</option> <option value=\"0.10\">0.10 %</option> <option value=\"0.25\">0.25 %</option> <option value=\"3.00\">3.00 %</option> <option value=\"5.00\">5.00 %</option> <option value=\"12.00\">12.00 %</option> <option value=\"18.00\">18.00 %</option> <option value=\"28.00\">28.00 %</option> </select> </td> <td class=\"product-detail-cell readonly-cell\" id=\"cgstValue\"> <input type=\"text\" class=\"table-cell-input\" id=\"cgstValue\" name=\"debitNoteProducts["+i+"][cgstValue]\" value=\"0.00\" readonly> <input type=\"text\" class=\"table-cell-input \" id=\"cgstRate\" name=\"debitNoteProducts["+i+"][cgstRate]\" value=\"0\" readonly> </td> <td class=\"product-detail-cell readonly-cell\" id=\"sgstValue\"> <input type=\"text\" class=\"table-cell-input\" id=\"sgstValue\" name=\"debitNoteProducts["+i+"][sgstValue]\" value=\"0.00\" readonly> <input type=\"text\" class=\"table-cell-input \" id=\"sgstRate\" name=\"debitNoteProducts["+i+"][sgstRate]\" value=\"0\" readonly> </td></tr> ";
	}

	var fixedContent =  "";
	
	function setFixedContent(i){
		fixedContent = "<tr class=\"product-details-row-fixed\"> <td class=\"product-detail-cell readonly-cell\" id=\"grossvalue\" rowspan=\"1\"> <input type=\"text\" class=\"table-cell-input\" id=\"grossvalue\" name=\"debitNoteProducts["+i+"][grossvalue]\" value=\"0.00\" readonly> </td> <td class=\"delete-row-cell\" colspan=\"1\" rowspan=\"1\"> <a href=\"javascript:;\" class=\"delete-row-link\"><svg xmlns=\"http://www.w3.org/2000/svg\" width=\"16\" height=\"16\" viewBox=\"0 0 16 16\"><g fill=\"none\" fill-rule=\"evenodd\"><path fill=\"#FFF\" d=\"M5.308 5.348l5.384 5.304\"></path><path stroke=\"#FF4949\" stroke-linecap=\"round\" d=\"M5.308 5.348l5.384 5.304\"></path><path fill=\"#FFF\" d=\"M10.692 5.348l-5.384 5.304\"></path><path stroke=\"#FF4949\" stroke-linecap=\"round\" d=\"M10.692 5.348l-5.384 5.304M15 8A7 7 0 1 1 1 8a7 7 0 0 1 14 0z\"></path></g></svg></a> </td> </tr>";
	}
	...
	$("input#dealerName").autocomplete({
		...
		source:[
			function( q,add ){
				...
				if( q !== "") {
					$.ajax({
						url: baseURL+"/debitNotes/select_dealer/"+encodeURIComponent(q),
						dataType : 'json',
	...
	//**************     on select of a debitNote product in selct product modal     ********* */
	//************************************************************************************** */
	//************************************************************************************** */
	...
	$("input#searchProductDescription").autocomplete({
		...
		source:[
			function( q,add ){
				...
				if( q !== "") {
					$.ajax({
						url: baseURL+"/debitNotes/select_product/"+encodeURIComponent(q),
						dataType : 'json',
						success: function(resp){
							add(resp.data);
						}
	...
	function add_empty_productrow() {
		...
		setScrollableContent(debitNote_product_serial);

		setFixedContent(debitNote_product_serial);

		$(".table-body-scrollable table tbody .debitNote-totals-row-scrollable").before(scrollableContent);
		$(".table-body-fixed table tbody .debitNote-totals-row-fixed").before(fixedContent);
		$('.table-body-scrollable table tbody tr.product-details-row-scrollable:last').attr('row-index', debitNote_product_serial);
		$('.table-body-fixed table tbody tr.product-details-row-fixed:last').attr('row-index', debitNote_product_serial);
		$('input#debitNoteSerial:last').val(debitNote_product_serial);
	...
	function renumber_productrow() {
		...
		$('input#debitNoteSerial').each(function(i, obj) {
			$(this).val(i+1);
			debitNote_product_serial = i+2;
		});
	}
	...
	tableFixed.on('click', 'a.delete-row-link', function(e){
		...
		debitNote_product_serial = 1; // Since renumbering wont happen after deleting all rows in previous step, assinging value manually
		renumber_productrow();
		setTotalsRow();
		finalRoundingoff();
	});
	...
	$('input#amountRecieved').on('change', function(e){
		setDebitNoteStatus($(this).val());
	});
	$('select#debitNoteStatus').on('change', function(e){
	...
	$(document).ready(function(){
		...
		$('.debitNote-products-list-table').hScroll(30);
	});
	...
	function setRowHeight() {
		$('tr.product-details-row-scrollable').each(function(i, obj) {
			var sourceElement = $(this).find('td#debitNoteSerial');
	...
	function setTotalsRow() {
		var totalsRow = $('.debitNote-totals-row-scrollable');
	...
	function setDebitNoteStatus(amountRecieved) {
		...
		$('select#debitNoteStatus').children('option[selected]').removeAttr('selected');

		if(amountRecieved < 1){
			$('select#debitNoteStatus').val("unpaid").change();
		}else if(amountRecieved < grandValue){
			$('select#debitNoteStatus').val("partial").change();
		}else if(amountRecieved === grandValue){
			$('select#debitNoteStatus').val("paid").change();
		}else if(amountRecieved > grandValue){
			$('select#debitNoteStatus').val("paid").change();
		}
		// if(amountRecieved < 1){
		// 	$('select#debitNoteStatus').children('option[value="unpaid"]').attr('selected', 'selected');
		// }else if(amountRecieved < $('input#grandValue').val()){
		// 	$('select#debitNoteStatus').children('option[value="partial"]').attr('selected', 'selected');
		// }else if(amountRecieved === $('input#amountRecieved').val()){
		// 	$('select#debitNoteStatus').children('option[value="paid"]').attr('selected', 'selected');
		// }
	}
