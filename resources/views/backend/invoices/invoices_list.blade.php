...
<script type="text/javascript">
	function checkPaymentAmount() { 
			...
			console.log(pendingBalance,invoicePayment,invoicePayment > pendingBalance,pendingBalance > invoicePayment);
			if(parseFloat(invoicePayment) > parseFloat(pendingBalance)){
	...
	$(document).ready(function() {
		...
		$('.cls_invoicePayment_btn').on('click', function(e){
			...
			$('#invoicePayment').val(pendingBalance);
