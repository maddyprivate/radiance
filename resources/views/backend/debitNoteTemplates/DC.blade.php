	    ...
	    <table class="intro_info no_border">
	        <tbody>			
				<tr class="debitNote_for_row no_border">
					@if($debitNoteStatus != 'quote')
						@if($copy === 'original')
							<td class="debitNote_for" colspan="4" ><img src="{{asset('img/debitNote/Original.png')}}" height="50px" /></td>
						@elseif($copy === 'DC')
							<td class="debitNote_for" colspan="4"><img src="{{asset('img/debitNote/DC.png')}}" height="50px" /></td>
						@elseif($copy === 'triplicate')
							<td class="debitNote_for" colspan="4"><img src="{{asset('img/debitNote/Triplicate.png')}}" height="50px" /></td>
						@endif
					@else
						<td class="debitNote_for" colspan="2"><img src="{{asset('img/debitNote/Blank.png')}}" height="50px" /></td>
					@endif
				</tr>
				<tr class="debitNote_for_row no_border " >
