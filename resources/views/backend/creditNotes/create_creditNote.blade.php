			...
			<div class="col-12">
				<div class="card">
					<div class="card-header d-flex align-items-center row no-gutters">
						<div class="col-6">
							<h3 class="h4">@lang('laryl-creditNotes.heading.new')</h3>
						</div>
						...
						<div class="col-12">
							<h6 class="t-cap">{{ $creditNote->businessName }}, <span id="placeoforigin">{{ $creditNote->placeOfOrigin }}</span></h6>
						</div>
					</div>
					<div class="card-body">
						<div class="container">
							...
							<form id="newCreditNoteForm" method="POST" action="{{ route('CreditNotes.creditNotes.store') }}">
								@csrf
...
<script>
	$('#newCreditNoteForm').on('submit', function(e){
		...
		$.ajax({
			...
			success: function(response){
				...
				swal_message("CreditNote Saved.", "success");
