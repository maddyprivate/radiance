<!doctype html>
	<html lang="en">
	<head>
		<title>Credit Note {{$serialPrefix.$serialNumber}} {{ucfirst($copy)}}</title>
			...
			<table class="intro_info no_border">
				<tbody>			
					<tr class="creditNote_for_row no_border">
    						@if($copy === 'original')
    						    <td class="creditNote_for" colspan="4" ><img src="{{asset('img/invoice/Original.png')}}" height="50px" /></td>
    						@elseif($copy === 'duplicate')
						        <td class="creditNote_for" colspan="4"><img src="{{asset('img/invoice/Duplicate.png')}}" height="50px" /></td>
						    @elseif($copy === 'triplicate')
						        <td class="creditNote_for" colspan="4"><img src="{{asset('img/invoice/Triplicate.png')}}" height="50px" /></td>
						    @endif
					</tr>
					<tr class="creditNote_for_row no_border " >
