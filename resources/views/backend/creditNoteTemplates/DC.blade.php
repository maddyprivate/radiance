...
<head>
	...
	<link href="{{ asset('/css/creditNoteTemplate/template1.css') }}" rel="stylesheet">
</head>
<body class="template_2">
	<htmlpageheader name="creditNoteHeader">
		<div id="top_header">
			@if($creditNoteStatus === 'quote')
				Quotation
			@else
	...
	<htmlpagefooter name="creditNoteFooter">
		Page {PAGENO} of {nbpg}
	</htmlpagefooter>
	<div>
	    <table class="intro_info no_border">
	        <tbody>			
				<tr class="creditNote_for_row no_border">
					@if($creditNoteStatus != 'quote')
						@if($copy === 'original')
							<td class="creditNote_for" colspan="4" ><img src="{{asset('img/creditNote/Original.png')}}" height="50px" /></td>
						@elseif($copy === 'DC')
							<td class="creditNote_for" colspan="4"><img src="{{asset('img/creditNote/DC.png')}}" height="50px" /></td>
						@elseif($copy === 'triplicate')
							<td class="creditNote_for" colspan="4"><img src="{{asset('img/creditNote/Triplicate.png')}}" height="50px" /></td>
						@endif
					@else
						<td class="creditNote_for" colspan="2"><img src="{{asset('img/creditNote/Blank.png')}}" height="50px" /></td>
					@endif
				</tr>
				<tr class="creditNote_for_row no_border " >
