			...
			<div class="col-12">
				<div class="card">
					<div class="card-header d-flex align-items-center row no-gutters">
						<div class="col-6">
							<h3 class="h4">@lang('laryl-debitNotes.heading.new')</h3>
						</div>
						...
						<div class="col-12">
							<h6 class="t-cap">{{ $debitNote->businessName }}, <span id="placeoforigin">{{ $debitNote->placeOfOrigin }}</span></h6>
						</div>
					</div>
					<div class="card-body">
						<div class="container">
							...
							<form id="newDebitNoteForm" method="POST" action="{{ route('DebitNotes.debitNotes.store') }}">
								@csrf
...
<script>
	$('#newDebitNoteForm').on('submit', function(e){
		...
		$.ajax({
			...
			success: function(response){
				...
				swal_message("DebitNote Saved.", "success");
